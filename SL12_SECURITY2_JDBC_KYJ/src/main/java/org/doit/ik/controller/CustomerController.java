...
public class CustomerController {
	...
	public String noticeReg(NoticeVO notice, HttpServletRequest request, RedirectAttributes rttr
							, Principal principal
		...
		int rowCount = this.memberShipService.insertAndPointUpOfMember(notice, principal.getName());
