...
*/
	...
	public void list(Model model, Criteria criteria) {
		...
		// 페이징 블럭
		model.addAttribute("pageMaker", new PageDTO(criteria, this.boardService.getTotal()));
		// list.jsp로 포워딩
	}
...
*/	
	...
	public String remove(Long bno, RedirectAttributes rttr
		...
		if (this.boardService.remove(bno)) {
			...
			int endPage = (int)(Math.ceil((double)this.boardService.getTotal()/criteria.getAmount()));
