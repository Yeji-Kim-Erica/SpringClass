 ...
 * Generated at: 2025-07-08 01:41:44 UTC
...
public final class dept_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("jar:file:/C:/Class/SpringClass/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/wtpwebapps/SL05_MYBATIS/WEB-INF/lib/jstl-1.2.jar!/META-INF/c.tld", Long.valueOf(1153352682000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>DEPT (2025. 6. 30. 오후 2:45:37)</title>\r\n");
      ...
      out.write("        WEB-INF/views/scott/dept.jsp\r\n");
      out.write("  </xmp>\r\n");
      out.write("  \r\n");
      ...
      out.write("	    			<button id=\"add\" class=\"add\" type=\"button\">부서 추가</button>\r\n");
      out.write("	    		</td>\r\n");
      out.write("	    	</tr>\r\n");
      out.write("	    </tfoot>\r\n");
      out.write("	  </table>\r\n");
      ...
      out.write("		});\r\n");
      out.write("		\r\n");
      out.write("		// 부서추가 모달 닫기\r\n");
      out.write("		$(\"button.cancel\").on(\"click\", function() {\r\n");
      out.write("			// addModal.css(\"display\", \"none\");\r\n");
      out.write("			addModal.hide();\r\n");
      out.write("			event.stopPropagation();\r\n");
      out.write("		});\r\n");
      out.write("		/*\r\n");
      out.write("		$(\"body\").on(\"click\", function() {\r\n");
      out.write("			if (event.currentTarget != addModal) { // HtmlBodyElement 등\r\n");
      out.write("				addModal.hide();\r\n");
      out.write("			}\r\n");
      out.write("		});\r\n");
      out.write("		*/\r\n");
      out.write("		\r\n");
      out.write("		// 부서추가 모달 확인 버튼 누를 때\r\n");
      out.write("		$(\"#add-dept\").on(\"click\", function() {\r\n");
      out.write("			let vdeptno = $(\"#add-modal :text[name=deptno]\").val();\r\n");
      out.write("			let vdname = $(\"#add-modal :text[name=dname]\").val();\r\n");
      out.write("			let vloc = $(\"#add-modal :text[name=loc]\").val();\r\n");
      out.write("			\r\n");
      out.write("			// js object\r\n");
      out.write("			const dept = {\r\n");
      out.write("					deptno : vdeptno,\r\n");
      out.write("					dname : vdname,\r\n");
      out.write("					loc : vloc\r\n");
      out.write("			};\r\n");
      out.write("			\r\n");
      out.write("			// dept.js -> deptService -> add() -> ajax로 부서정보 추가\r\n");
      out.write("			deptService.add(dept, function(result) {\r\n");
      out.write("				// 1. 모달창 닫기\r\n");
      out.write("				addModal.hide();\r\n");
      out.write("				// 2. 응답 메시지 처리\r\n");
      out.write("				if (result == 'SUCCESS') {\r\n");
      out.write("					 let tr = $(`\r\n");
      out.write("			                       <tr>\r\n");
      out.write("			                         <td><input type=\"checkbox\" data-deptno=\"${ vdeptno }\" value=\"${ vdeptno }\" name=\"deptno\"></td>\r\n");
      out.write("			                         <td>${ vdeptno }</td>\r\n");
      out.write("			                         <td>${ vdname }<span class=\"badge right red\">0</span></td>\r\n");
      out.write("			                         <td>${ vloc }</td>\r\n");
      out.write("			                         <td align=\"center\"><span class=\"material-symbols-outlined delete\" data-deptno=\"${ vdeptno }\">close</span></td>\r\n");
      out.write("			                       </tr>\r\n");
      out.write("		                       `);\r\n");
      out.write("					$(tr).appendTo($(\"table body\"))\r\n");
      ...
      out.write("					                	if(result === 'SUCCESS') spanDelete.closest(\"tr\").remove();\r\n");
      out.write("					                });\r\n");
      out.write("		                         } // if\r\n");
      out.write("							});\r\n");
      out.write("					 \r\n");
      ...
      out.write("		\r\n");
      out.write("		// 부서삭제\r\n");
      out.write("		// #tbl-dept > tbody > tr:nth-child(1) > td:nth-child(5) > span\r\n");
      out.write("		$(\"#tbl-dept > tbody > tr > td:nth-child(5) > span\").on(\"click\", function() {\r\n");
      out.write("			// alert(\"부서 삭제\");\r\n");
      out.write("			if (confirm(\"정말 삭제할까요?\")) {\r\n");
      out.write("				let deptno = $(this).data(\"deptno\");\r\n");
      out.write("                deptService.remove(deptno, function (result){\r\n");
      out.write("                	if(result === 'SUCCESS') $(event.currentTarget).closest(\"tr\").remove();\r\n");
      out.write("                });\r\n");
      out.write("			}\r\n");
      out.write("		});\r\n");
      out.write("		\r\n");
  ...
  private boolean _jspx_meth_c_005fforEach_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    // /WEB-INF/views/scott/dept.jsp(121,6) name = items type = javax.el.ValueExpression reqTime = true required = false fragment = false deferredValue = true expectedTypeName = java.lang.Object deferredMethod = false methodSignature = null
    _jspx_th_c_005fforEach_005f0.setItems(new org.apache.jasper.el.JspValueExpression("/WEB-INF/views/scott/dept.jsp(121,6) '${list}'",_jsp_getExpressionFactory().createValueExpression(_jspx_page_context.getELContext(),"${list}",java.lang.Object.class)).getValue(_jspx_page_context.getELContext()));
    // /WEB-INF/views/scott/dept.jsp(121,6) name = var type = java.lang.String reqTime = false required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
    ...
    try {
      ...
      if (_jspx_eval_c_005fforEach_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("<tr>\r\n");
          out.write("	    			<td><input type=\"checkbox\" name=\"deptno\" value=\"");
          ...
          out.write("\" data-deptno=\"{dto.deptno}\"></td>\r\n");
          out.write("	    			<td>");
          out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${dto.deptno}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
          out.write("</td>\r\n");
          out.write("	    			<td>");
